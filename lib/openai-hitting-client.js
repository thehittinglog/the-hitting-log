...
If hasSignificantProblem is false, do not manufacture a weakness. Say there is no major weakness and frame biggestNegativeIndicator only as a smaller supported opportunity.
Always include the supplied sample description and sample-size warning when present.
Lead with the conclusion or athlete-facing insight. Do not begin with labels such as "Sample:" or "Sample-size warning:".
